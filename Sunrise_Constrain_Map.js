...
function draw()
{
	...
	//progress from day to night based on mouseX
	...
	//trunk
		...
		fill(0,150,0);
		ellipse(tree.x, tree.y - tree.trunkHeight/2 + 10, tree.canopyWidth,tree.canopyHeight);
			
		
	//TASK: make the scene dark by drawing a rectangle that covers the whole canvas.
	const darkness = map(t,0,1,0,180 );
	fill(0, darkness);
